...
Neste projeto, foram implementádas diversas funções para reforçar o aprendizado sobre o assunto.
...
[Repositório do projeto Trybe](https://github.com/tryber/sd-06-project-playground-functions)
