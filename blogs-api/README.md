...
Foi desenvolvida uma API de um CRUD posts de blog (com o sequelize) utilizando alguns endpoints (seguindo os princípios do REST) que foram conectados ao banco de dados, aplicando os princípios SOLID. Inicialmente foi criada uma tabela para os usuários que desejam se cadastrar na aplicação. Após isso, a tabela blogPost é capaz de guardar todas as informações dos posts realizados na plataforma.
...
[Repositório do projeto Trybe](https://github.com/tryber/sd-06-project-blogs-api)
