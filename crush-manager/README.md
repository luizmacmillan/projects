...
Foi desenvolvida uma API de um CRUD de crushs contendo alguns endpoints que irão ler e escrever em um arquivo, isso utilizando o módulo `fs`.
...
[Repositório do projeto Trybe](https://github.com/tryber/sd-06-crush-manager)
