...
Neste projeto, diferentemente dos outros, foram utilizados vários datasets, tornando possível praticar em vários cenários os diversos operadores e estágios do `aggregation pipeline`.
...
[Repositório do projeto Trybe](https://github.com/tryber/sd-06-mongodb-aggregations)
